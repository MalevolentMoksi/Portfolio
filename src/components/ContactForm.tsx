...
type ContactFormErrors = Partial<Record<ValidatedField, string>>;
...
const ContactForm = () => {
  ...
  const normalizeFormData = (data: ContactFormData): ContactFormData => ({
    ...data,
    name: data.name.trim(),
  ...
  const validateForm = (data: ContactFormData): ContactFormErrors => {
    ...
    if (!data.message) newErrors.message = t('common.contactForm.validation.messageRequired');
      ...
      newErrors.message = t('common.contactForm.validation.messageTooLong', {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (field !== 'website' && errors[field as ValidatedField]) {
  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit} noValidate>
      ...
      <button type="submit" disabled={isSubmitting} className="submit-btn" aria-busy={isSubmitting}>
