...
export const MOOD_TEXT_POOL = {
  ...
  sad: ['Mes batteries se vident...', 'Un câlin, peut-être ?', "Tu m'as oublié…"],
  ...
  woozy: [
    'Téléportation... réussie... je crois.',
    'Systèmes en cours de stabilisation...',
    'Calibration gyroscopique requise.',
  ],
  ...
  sleep: [
    'Zzz...',
    'Mode veille activé...',
    'Analyse des rêves en cours...',
    'Traitement des souvenirs de la journée...',
  ],
...
export const THOUGHT_SYMBOLS = {
  heart: (
    <path
      d="M8 13 C8 13 2.5 9 2.5 5.5 C2.5 3.5 4 2 6 2 C7 2 7.8 2.7 8 3 C8.2 2.7 9 2 10 2 C12 2 13.5 3.5 13.5 5.5 C13.5 9 8 13 8 13Z"
      fill="currentColor"
    />
  ),
  star: (
    <path
      d="M8 1.5 L9.8 6 L14.5 6 L10.8 9 L12.2 13.5 L8 10.8 L3.8 13.5 L5.2 9 L1.5 6 L6.2 6 Z"
      fill="currentColor"
    />
  ),
  note: (
  ...
  zzz: (
    <>
      <path
        d="M3.5 12.5 L7.5 12.5 L3.5 15 L7.5 15"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      ...
      />
      <path
        d="M5.5 7.5 L10.5 7.5 L5.5 10.5 L10.5 10.5"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M8 2.5 L13.5 2.5 L8 6 L13.5 6"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
