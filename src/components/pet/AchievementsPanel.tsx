...
import { ACHIEVEMENTS } from './petConstants';
...
const AchievementsPanel = ({ unlocked = [] }: AchievementsPanelProps) => {
    ...
    <div className="pet-achievements">
      ...
      <div className="pet-achievements-grid" role="list">
        {ACHIEVEMENTS.map((ach) => {
          ...
          const label = t(`common.pet.achievements.items.${ach.key}.label`, {
            defaultValue: ach.label,
          });
          const desc = t(`common.pet.achievements.items.${ach.key}.desc`, {
            defaultValue: ach.desc,
          });
          const hint = t(`common.pet.achievements.items.${ach.key}.hint`, {
            defaultValue: ach.hint,
          });
          return (
            <div
              key={ach.id}
            ...
            >
              <div className="pet-ach-icon">
                {isUnlocked ? (
                  ACHIEVEMENT_ICONS[ach.id as keyof typeof ACHIEVEMENT_ICONS] || null
                ) : (
                  <LockIcon />
                )}
              </div>
              ...
              {isUnlocked ? (
                ...
                ach.hint && (
                  <div className="pet-ach-tooltip pet-ach-tooltip--hint" role="tooltip">
                    <span className="pet-ach-tooltip-hint-label">
                      {t('common.pet.achievements.hint')}
                    </span>
