...
const SpacecraftSVG = () => (
  <svg width="112" height="40" viewBox="0 0 70 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
    {/* Corps principal */}
    <path d="M4 12 L20 6 L58 8 L68 12 L58 16 L20 18 Z" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.9" />
    {/* Cockpit */}
    <ellipse cx="56" cy="12" rx="5" ry="2.5" stroke="currentColor" strokeWidth="0.7" opacity="0.6" />
    {/* Réacteurs arrière */}
    ...
    <g className="commuter-exhaust">
      <line x1="-2" y1="11" x2="-16" y2="11.5" stroke="currentColor" strokeWidth="0.6" strokeDasharray="3 4" />
      <line x1="-2" y1="12" x2="-18" y2="12" stroke="currentColor" strokeWidth="0.4" strokeDasharray="2 5" />
      <line x1="-2" y1="13" x2="-16" y2="12.5" stroke="currentColor" strokeWidth="0.6" strokeDasharray="3 4" />
    </g>
  </svg>
);
...
const SatelliteSVG = () => (
  <svg width="88" height="72" viewBox="0 0 52 44" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
    {/* Corps central */}
    <rect x="18" y="16" width="16" height="12" rx="1" stroke="currentColor" strokeWidth="1" opacity="0.8" />
    {/* Panneau solaire gauche — rotation lente */}
    <g className="commuter-panel commuter-panel--left">
      <rect x="1" y="18" width="14" height="8" rx="0.5" stroke="currentColor" strokeWidth="0.7" opacity="0.5" />
    ...
    <g className="commuter-panel commuter-panel--right">
      <rect x="37" y="18" width="14" height="8" rx="0.5" stroke="currentColor" strokeWidth="0.7" opacity="0.5" />
...
const RoverSVG = () => (
  <svg width="104" height="56" viewBox="0 0 64 34" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
    {/* Châssis */}
    <rect x="12" y="14" width="40" height="10" rx="2" stroke="currentColor" strokeWidth="1" opacity="0.8" />
    ...
    <g className="commuter-wheel commuter-wheel--small">
      ...
      <line x1="32" y1="25" x2="32" y2="31" stroke="currentColor" strokeWidth="0.3" opacity="0.25" />
    </g>
    {/* Essieux */}
    ...
    {/* Bras articulé */}
    <polyline points="14,14 10,8 6,10" stroke="currentColor" strokeWidth="0.7" opacity="0.5" strokeLinecap="round" strokeLinejoin="round" />
    {/* Panneau photovoltaïque */}
    <rect x="24" y="11" width="14" height="3" rx="0.5" stroke="currentColor" strokeWidth="0.5" opacity="0.4" />
  </svg>
);

/* ─── Pool de véhicules ─── */

const VEHICLE_TYPES = ['spacecraft', 'satellite', 'rover'];
...
const randomType = () => VEHICLE_TYPES[Math.floor(Math.random() * VEHICLE_TYPES.length)];
...
const OccasionalCommuter = () => {
  const [vehicle, setVehicle] = useState(null); // { type, key }
  ...
  const spawnVehicle = useCallback((type) => {
    if (!mountedRef.current) return;
    clearAllTimers();
    const chosenType = VEHICLE_TYPES.includes(type) ? type : randomType();
  ...
  useEffect(() => {
    window.spawnCommuter = (type) => spawnVehicle(type);
    return () => { delete window.spawnCommuter; };
  }, [spawnVehicle]);
