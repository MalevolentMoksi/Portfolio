 ...
 */
function pickPositions(count: any) {
  const positions: any = [];
  let attempts = 0;
  while (positions.length < count && attempts < 400) {
    ...
    const fits = positions.every((p: any) => Math.abs(p - pos) > MIN_GAP_PCT);
...
const WarmindDiorama = () => (
  ...
  >
    ...
    <polygon
      className="warmind-core"
      points="24,30 34,42 24,54 14,42"
      stroke="currentColor"
      strokeWidth="1.2"
      fill="none"
    />
...
const TeslaCoilDiorama = () => (
  ...
  >
    ...
    <path
      className="tesla-arc tesla-arc--1"
      d="M29 13 Q37 6 32 3"
      stroke="currentColor"
      strokeWidth="0.8"
      fill="none"
    />
    <path
      className="tesla-arc tesla-arc--2"
      d="M19 13 Q11 6 16 3"
      stroke="currentColor"
      strokeWidth="0.8"
      fill="none"
    />
    <path
      className="tesla-arc tesla-arc--3"
      d="M26 10 Q33 3 29 1"
      stroke="currentColor"
      strokeWidth="0.5"
      fill="none"
