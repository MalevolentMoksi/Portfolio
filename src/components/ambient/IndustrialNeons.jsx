...
const HazardSign = ({ style }) => (
  ...
  >
    ...
    {/* Plaque de fixation */}
    <rect x="24" y="-3" width="12" height="6" rx="1"
      fill="#3a3a3a" stroke="#555" strokeWidth="0.5" />
    {/* Boulon */}
    ...
    <g transform="translate(0, 12)">
      <polygon
        ...
        fill="none" stroke="#FF5722" strokeWidth="2"
        strokeLinejoin="round" className="neon-stroke" />
      <polygon
        points="30,12 48,44 12,44"
        fill="none" stroke="rgba(255, 87, 34, 0.4)"
        strokeWidth="0.8" className="neon-stroke" />
      ...
      <circle cx="30" cy="40" r="1.8"
        fill="#FFD600" className="neon-stroke neon-stroke--accent" />
    </g>
  </svg>
);

/* ─── Enseigne : éclair sur potence droite en L ─── */
const BoltSign = ({ style }) => (
  <svg
  ...
  >
    ...
    <g transform="translate(0, 10)">
      ...
      <polyline
        points="22,2 10,28 20,28 14,58 34,22 22,22 30,2"
        fill="none" stroke="rgba(255, 214, 0, 0.2)"
...
const CautionSign = () => (
  ...
  >
    ...
    <line x1="-20" y1="-28" x2="160" y2="-28"
      stroke="#4a4a4a" strokeWidth="3" />

    {/* Chaîne gauche — maillons alternés */}
    {[0, 5, 10, 15, 20].map((y, i) => (
      <rect key={`cl-${i}`}
        x="18" y={-26 + y} width="4" height="4" rx="1"
        fill="none" stroke="#666" strokeWidth="0.8" />
    ))}
    {/* Chaîne droite */}
    {[0, 5, 10, 15, 20].map((y, i) => (
      <rect key={`cr-${i}`}
        x="118" y={-26 + y} width="4" height="4" rx="1"
        fill="none" stroke="#666" strokeWidth="0.8" />
    ))}

    {/* Plaque du panneau */}
    <rect x="0" y="0" width="140" height="24" rx="2"
      fill="rgba(26, 26, 26, 0.8)" stroke="#4a4a4a" strokeWidth="1" />
    {/* Bordure néon */}
    <rect x="2" y="2" width="136" height="20" rx="1.5"
      fill="none" stroke="#FF5722" strokeWidth="1.2"
      className="neon-stroke" />
    {/* Texte néon */}
    <text
      x="70" y="16" textAnchor="middle"
      fontFamily="monospace" fontSize="12" fontWeight="bold"
      fill="#FF5722" letterSpacing="4"
      className="neon-text"
    >
      CAUTION
    </text>
