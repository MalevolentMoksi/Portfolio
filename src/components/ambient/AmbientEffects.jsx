...
// const FloatingGeometry = lazy(() => import('./FloatingGeometry.jsx')); // désactivé — remplacé par DefaultStarField
// const DefaultStarField = lazy(() => import('./DefaultStarField.jsx')); // désactivé — conflits visuels avec particles existants
