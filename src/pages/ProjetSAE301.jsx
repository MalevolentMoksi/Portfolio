    ...
    <>
      <article className="project-article" ref={contentRef}>
        ...
        <section id="project-detail">
          ...
          <p>
            En France, <strong>9,3 millions de personnes</strong> sont aidants de proches dépendants,
            confrontées à une « double journée » qui génère une lourde charge mentale souvent invisible.
            Face aux enjeux du <em>Grand Âge</em> et aux profils <strong>GIR 3–4</strong> (grille AGGIR),
            le manque d'outils numériques collaboratifs, accessibles et centrés sur l'humain est criant.
          </p>
          <p>
            C'est de ce constat qu'est né <strong>Aidémé</strong> — contraction d'« Aider » et
            d'« Aimer » — une application Web permettant à plusieurs aidants de coordonner
            le suivi d'une même personne accompagnée en rendant visible ce <em>travail invisible</em>,
            en allégeant la charge mentale et en préservant le lien affectif (galerie photo pour
          ...
          <ul>
            <li>
              <strong>Claire</strong>, aidante sur place — a besoin de tout centraliser pour ne
              rien oublier entre deux visites.
            </li>
            <li>
          ...
          <p>
            ...
            <br /><br />
            Réalisé en équipe de 6 – Team 08 « Aimédia », IUT2 Info, Université Grenoble Alpes
            (2ᵉ année BUT Informatique, SAÉ S3.01).
          </p>
        </section>
        ...
        <section id="features">
          ...
          <ul>
            <li>
              <strong>Authentification &amp; comptes</strong> — inscription, connexion par session PHP,
              hachage SHA-256 côté client, mot de passe oublié, photo de profil
            </li>
            <li>
            ...
            <li>
              <strong>Contacts</strong> — CRUD de contacts (médecins, proches, intervenants) associés
              à chaque aidé, liaison aux événements
            </li>
            <li>
              <strong>Agenda</strong> — événements avec date, heure, durée, lieu ; vues mois / semaine ;
              vue mobile dédiée ; tags colorés filtrables ; masquer les événements passés / week-ends
            </li>
            <li>
            ...
            <li>
              <strong>Coffre-fort de fichiers</strong> — arborescence hiérarchique de dossiers, upload
              / téléchargement / renommage / suppression, prévisualisation de documents,
        ...
        <section id="design">
          ...
          <p>
            ...
            fuit délibérément les clichés hospitaliers (croix, stéthoscope) pour adopter un
            registre chaleureux et familial.
          </p>
        ...
        <section id="techniques">
          ...
          <ul>
            <li>React 19, React Router 7, hooks (<code>useState</code>, <code>useEffect</code>, <code>useContext</code>), <code>createBrowserRouter</code></li>
            <li>Vite 7 — bundling, HMR et proxy <code>/api/*</code> → <code>localhost:8000</code></li>
            <li>PHP 8.4 — architecture MVC sans framework, routage via <code>index.php</code>, 59 contrôleurs REST</li>
            <li>SQLite 3 via PDO — 16 tables, pattern DAO (9 classes modèle/DAO), singleton <code>DAL.class.php</code></li>
            <li>
              ...
              <strong>PostgreSQL</strong> (gestion avancée des utilisateurs et des accès concurrents)
              sans modifier les couches supérieures
            </li>
          ...
          <ul>
            <li>Hachage des mots de passe <strong>SHA-256</strong> côté client avant transmission</li>
            <li>
            ...
            <li>Sessions PHP avec CORS strict et <code>credentials: &quot;include&quot;</code></li>
            <li>Workflow de validation photos (statut « en attente » → approbation responsable)</li>
            <li>Gestion du consentement ; prévu : <em>Age Gating</em> pour les mineurs</li>
          </ul>
        </section>
        ...
        <section id="skills">
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>Composer des écrans avec des composants React réutilisables (30+ composants, sous-dossiers par domaine)</li>
                <li>Gérer l'état global via <code>AppContext</code> (aidé sélectionné, rôle responsable, préférences d'accessibilité)</li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>Pattern DAO avec singleton PDO (<code>DAL.class.php</code>)</li>
              </ul>
            </li>
          </ul>
        </section>
        ...
        <section id="objectives">
          ...
          <ul>
            ...
            <li>Mettre en pratique le développement full-stack (React + PHP + SQL) en conditions réelles</li>
            <li>Respecter les contraintes RGPD pour des données médicales sensibles</li>
            <li>Garantir l'accessibilité à un public potentiellement peu à l'aise avec le numérique</li>
          </ul>
        </section>
        ...
        <section id="group-work">
          ...
          <ul>
            <li><strong>Paolo</strong> — Chef de projet, coordination générale</li>
            <li><strong>Jérémie</strong> — Responsable Qualité</li>
            <li><strong>Simon</strong> — Référent Technique (back-end)</li>
            <li><strong>Enzo</strong> — Responsable IHM &amp; accessibilité (front-end)</li>
            <li><strong>Macéo</strong> — Communication &amp; Documentation</li>
            <li><strong>Noam</strong> — Réseau &amp; Système, déploiement</li>
          </ul>

          <h3>Méthodologie &amp; évolution</h3>
          <p>
            Le projet a évolué en trois phases. En <strong>phase 1</strong>, des séances de travail
            nocturnes intensives ont mis en évidence la nécessité d'une meilleure organisation.
            En <strong>phase 2</strong>, l'équipe a d'abord séparé les développements « Front »
            et « Back », ce qui a généré des frictions d'intégration. En <strong>phase 3</strong>,
            nous avons pivoté vers un développement <em>feature-based</em> (par fonctionnalité
            complète), ce qui a considérablement accéléré la production et amélioré la cohésion
            de l'équipe.
          </p>
          <p>
        ...
        <section id="testing">
          ...
          <p>
            L'application n'a pas seulement été codée : elle a été <strong>testée auprès de
            15 utilisateurs</strong> aux profils variés (aidants familiaux, professionnels
            de santé, personnes peu à l'aise avec le numérique).
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Méthode SUS</strong> (System Usability Scale) — questionnaire standardisé
              pour mesurer la facilité d'utilisation perçue ; a permis de valider que l'interface
              restait compréhensible pour le persona Bruno (auxiliaire de vie)
            </li>
            <li>
        ...
        <section id="individual-work">
          ...
          <ul>
            ...
            <li>
              Analyse statistique des résultats et synthèse des grands axes d'usage
            </li>
            <li>
          ...
          <ul>
            <li>
              Conception de l'architecture des écrans et production des <strong>wireframes
              basse et haute fidélité</strong> sur <strong>Whimsical</strong>
            </li>
            <li>
            ...
            <li>
              ...
              composants réutilisables, gestion des variantes peu ergonomique et collaboration
              en temps réel perfectible. Pour les prochains projets, je souhaite migrer vers{' '}
          ...
          <ul>
            <li>
              <strong>Développement du front-end en très grande partie</strong> : architecture
              React (<code>createBrowserRouter</code>), contexte global <code>AppContext</code>,
            ...
            <li>
              Rôle de <strong>connecteur Front / Back-end</strong> : intégration de l'API PHP
              via proxy Vite, uniformisation des appels <code>fetch</code>, gestion des sessions
              et des erreurs, liaison entre les composants React et les 59 contrôleurs PHP
            </li>
            <li>
              Participation aux tests utilisateurs : rédaction des scénarios et dépouillement
              des résultats SUS
            </li>
        ...
        <section id="perspectives">
          ...
          <ul>
            <li>Intégrer des tests automatisés (Jest, PHPUnit) dès le début pour réduire la dette technique</li>
            <li>Adopter le développement feature-based dès la phase 1 plutôt que de séparer Front / Back</li>
            <li>Prévoir un environnement de staging (Docker) pour simuler les contraintes serveur IUT plus tôt</li>
          </ul>

          <h3>Roadmap envisagée</h3>
          <ul>
            <li>
              <strong>Déploiement réel</strong> : achat d'un nom de domaine et migration vers
              un serveur avec <strong>PostgreSQL</strong>
            </li>
            <li>
            ...
            <li>
              <strong>Serveur SMTP</strong> : emails transactionnels pour la réinitialisation de
              mot de passe, les notifications importantes et la vérification parentale
            </li>
            <li>
              <strong>Progressive Web App</strong> : mode hors-ligne pour les aidants en zone
              rurale ou à connectivité limitée
            </li>
          </ul>
        </section>
